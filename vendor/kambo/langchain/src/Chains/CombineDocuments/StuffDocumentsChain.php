...
class StuffDocumentsChain extends BaseCombineDocumentsChain
{
    ...
    private function getInputs(array $docs, array $additionalArguments = []): array
    {
        ...
        error_log('StuffDocumentsChain');
        error_log(print_r($docs, true));

        // Check here if the score of the document is low, if so, dont include
        // If we have a post_id not equal 0, get the full page or post, but limit it to 2000 chars
